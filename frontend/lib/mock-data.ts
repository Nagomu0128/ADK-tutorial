...
// ===== Agent Statuses (using backend kebab-case names) =====
export const mockAgentStatuses: readonly AgentStatus[] = [
  { agentName: "user-profile-agent", status: "completed", startedAt: "2026-03-10T09:00:00Z", completedAt: "2026-03-10T09:00:02Z" },
  { agentName: "news-agent", status: "completed", startedAt: "2026-03-10T09:00:02Z", completedAt: "2026-03-10T09:00:08Z" },
  { agentName: "stock-agent", status: "completed", startedAt: "2026-03-10T09:00:02Z", completedAt: "2026-03-10T09:00:06Z" },
  { agentName: "sentiment-agent", status: "running", startedAt: "2026-03-10T09:00:08Z", completedAt: null },
  { agentName: "risk-agent", status: "running", startedAt: "2026-03-10T09:00:08Z", completedAt: null },
  { agentName: "report-agent", status: "pending", startedAt: null, completedAt: null },
];
...
export const mockAgentStatusesCompleted: readonly AgentStatus[] = [
  ...
  { agentName: "news-agent", status: "completed", startedAt: "2026-03-10T09:00:02Z", completedAt: "2026-03-10T09:00:08Z" },
  { agentName: "stock-agent", status: "completed", startedAt: "2026-03-10T09:00:02Z", completedAt: "2026-03-10T09:00:06Z" },
  { agentName: "sentiment-agent", status: "completed", startedAt: "2026-03-10T09:00:08Z", completedAt: "2026-03-10T09:00:14Z" },
  { agentName: "risk-agent", status: "completed", startedAt: "2026-03-10T09:00:08Z", completedAt: "2026-03-10T09:00:12Z" },
  { agentName: "report-agent", status: "completed", startedAt: "2026-03-10T09:00:14Z", completedAt: "2026-03-10T09:00:20Z" },
];
...
// ===== Stock Results (nested indicators to match backend TechIndicators) =====
